# ============================================================
# SHANECODES REPAIR TOOL - NEON EDITION v11.1
# ============================================================
# Fixed: Non-blocking UI with background job
# ============================================================

# ============================================================
# CONFIGURATION
# ============================================================
$script:GITHUB_TOKEN = "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"
...
function Invoke-Download {
    ...
    try {
        ...
        $webClient.Headers.Add("Authorization", "token $($script:GITHUB_TOKEN)")
